...
export function Quote({ s }: { s: QuoteSection }) {
  return (
    <section className={`${sectionBackground(s.background, SectionBackground.Green)} px-6 py-28 text-center`}>
      <Reveal variant={RevealVariant.Up} className="mx-auto max-w-4xl">
        <blockquote className="font-display-alt text-2xl italic leading-snug">
          &ldquo;{s.quote}&rdquo;
        </blockquote>
        {s.author && (
