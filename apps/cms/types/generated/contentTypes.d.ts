...
export interface ApiCakeCake extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::cake.cake'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide chrome shown on every page: brand (name, tagline, logo), the header and footer navigation menus, the header CTA, the footer legal line, and the default SEO tags. Contact details, opening hours, social links and reservation live in the separate Contact single type.';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
  ...
  attributes: {
    ...
    footerEventsHeading: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    footerLegal: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    footerNavHeading: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    footerSocialHeading: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Every page of the site other than the home page \u2014 one entry per page (e.g. Kaviare\u0148, O n\u00E1s, Kontakt). Each entry has a title, a URL slug, and a body you build from section blocks. Add a new page here without any developer work; the slug decides its address (/kaviaren, /o-nas\u2026).';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
